...
class Oferente {
    ...
    static async create(oferenteData) {
        ...
        // MySQL's JSON column type handles objects automatically
        // Only stringify if it's already an object, otherwise pass as-is
    ...
    static async findAll() {
        ...
        // MySQL automatically parses JSON columns
        // Only parse if it's still a string (shouldn't happen with mysql2 + JSON column)
    ...
    static async findById(id) {
        ...
        // MySQL automatically parses JSON columns with mysql2
